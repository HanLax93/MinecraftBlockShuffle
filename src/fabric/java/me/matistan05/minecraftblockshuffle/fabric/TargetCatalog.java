...
final class TargetCatalog {
    ...
    static {
        // Tier 1 (round starts): terrain-feature oriented targets that should still be reachable
        // in one round on a normal survival world without forcing immediate trivial farming.
        add(BlockDifficulty.EASY, Dimension.OVERWORLD, "surface-foundation",
            "stone", "cobblestone", "tuff", "calcite", "dripstone_block", "deepslate", "cobbled_deepslate",
            "gravel", "sand", "red_sand", "clay", "mud", "dirt", "coarse_dirt", "grass_block", "moss_block", "podzol",
            "mycelium", "rooted_dirt",
            "packed_mud", "snow_block", "ice", "packed_ice", "blue_ice");

        add(BlockDifficulty.EASY, Dimension.OVERWORLD, "forest-heights",
            "oak_log", "oak_wood", "stripped_oak_log",
            "birch_log", "birch_wood", "stripped_birch_log",
            "spruce_log", "spruce_wood", "stripped_spruce_log",
            "jungle_log", "jungle_wood", "stripped_jungle_wood",
            "acacia_log", "acacia_wood", "stripped_acacia_log",
            "dark_oak_log", "dark_oak_wood", "stripped_dark_oak_log",
            "cherry_log", "cherry_wood", "stripped_cherry_log",
            "mangrove_log", "mangrove_roots", "muddy_mangrove_roots",
            "bamboo_block");

        add(BlockDifficulty.EASY, Dimension.OVERWORLD, "feature-crafts",
            "crafting_table", "furnace", "chest", "barrel",
            "glass", "glass_pane", "stone_bricks", "chiseled_stone_bricks", "mossy_cobblestone",
            "mossy_stone_bricks", "terracotta", "white_terracotta");
        ...
        add(BlockDifficulty.NORMAL, Dimension.OVERWORLD, "spruce", "spruce_planks", "spruce_slab",
            "spruce_stairs", "spruce_fence", "spruce_door", "spruce_trapdoor", "spruce_leaves");
        add(BlockDifficulty.NORMAL, Dimension.OVERWORLD, "jungle", "jungle_planks", "jungle_slab",
            "jungle_stairs", "jungle_fence", "jungle_door", "jungle_trapdoor", "jungle_leaves");
        add(BlockDifficulty.NORMAL, Dimension.OVERWORLD, "acacia", "acacia_planks", "acacia_slab",
            "acacia_stairs", "acacia_fence", "acacia_door", "acacia_trapdoor", "acacia_leaves");
        add(BlockDifficulty.NORMAL, Dimension.OVERWORLD, "dark_oak", "dark_oak_planks",
            "dark_oak_slab", "dark_oak_stairs", "dark_oak_fence", "dark_oak_door", "dark_oak_trapdoor",
            "dark_oak_leaves");
        add(BlockDifficulty.NORMAL, Dimension.OVERWORLD, "cherry", "cherry_planks", "cherry_slab",
            "cherry_stairs", "cherry_fence", "cherry_door", "cherry_trapdoor", "cherry_leaves");
        add(BlockDifficulty.NORMAL, Dimension.OVERWORLD, "bamboo", "bamboo_planks", "bamboo_slab",
            "bamboo_stairs", "bamboo_mosaic", "bamboo_door", "bamboo_trapdoor");
        add(BlockDifficulty.NORMAL, Dimension.OVERWORLD, "mangrove", "mangrove_planks",
        ...
        add(BlockDifficulty.NORMAL, Dimension.OVERWORLD, "color", "red_wool", "yellow_wool", "blue_wool",
            "black_wool", "orange_wool", "white_bed", "red_bed", "yellow_bed", "hay_block", "coal_block",
            "bookshelf");
    ...
    private static Set<String> resourcesFor(String family) {
        return switch (family) {
            case "surface-foundation" -> Set.of("stone", "dirt", "sand", "gravel", "clay", "tuff", "calcite");
            case "forest-heights" -> Set.of("oak_log", "oak_leaves", "spruce_log", "spruce_leaves", "birch_log", "birch_leaves",
                "jungle_log", "jungle_leaves", "acacia_log", "acacia_leaves", "dark_oak_log", "dark_oak_leaves",
                "cherry_log", "cherry_leaves", "mangrove_log", "mangrove_roots");
            case "feature-crafts" -> Set.of("stone", "clay", "dirt", "cobblestone");
            ...
            case "stone" -> Set.of("stone", "cobblestone", "andesite", "diorite", "granite");
